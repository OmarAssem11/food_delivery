...
import '../features/orders/domain/usecases/get_order_details_use_case.dart'
    as _i29;
import '../features/orders/presentation/bloc/orders_cubit.dart' as _i34;
...
Future<_i1.GetIt> $initGetIt(_i1.GetIt get,
  ...
  gh.lazySingleton<_i13.ProfileRemoteDataSourceImpl>(
      () => _i13.ProfileRemoteDataSourceImpl(get<dynamic>()));
  gh.lazySingleton<_i14.RestaurantsApiService>(
      () => _i14.RestaurantsApiService(get<_i3.Dio>()));
  gh.lazySingleton<_i15.RestaurantsRemoteDataSource>(() =>
      _i16.RestaurantsRemoteDataSourceImpl(get<_i14.RestaurantsApiService>()));
  await gh.factoryAsync<_i17.SharedPreferences>(
      () => appModule.getSharedPreferences,
      preResolve: true);
  gh.lazySingleton<_i18.AuthApiService>(
      () => _i18.AuthApiService(get<_i3.Dio>()));
  gh.lazySingleton<_i19.AuthLocalDataSource>(
      () => _i20.AuthLocalDataSourceImpl(get<_i17.SharedPreferences>()));
  gh.lazySingleton<_i21.AuthRemoteDataSource>(
      () => _i22.AuthRemoteDataSourceImpl(get<_i18.AuthApiService>()));
  gh.lazySingleton<_i23.CartApiService>(
      () => _i23.CartApiService(get<_i3.Dio>()));
  gh.lazySingleton<_i24.CartRemoteDataSource>(
      () => _i25.CartRemoteDataSourceImpl(get<_i23.CartApiService>()));
  gh.lazySingleton<_i26.CheckoutApiService>(
      () => _i26.CheckoutApiService(get<_i3.Dio>()));
  gh.lazySingleton<_i27.CheckoutRemoteDataSource>(
      () => _i28.CheckoutRemoteDataSourceImpl(get<_i26.CheckoutApiService>()));
  gh.lazySingleton<_i29.GetOrderDetailsUseCase>(
      () => _i29.GetOrderDetailsUseCase(get<_i7.OrdersRepository>()));
  gh.lazySingleton<_i30.LocalizationLocalDataSource>(() =>
      _i31.LocalizationLocalDataSourceImpl(get<_i17.SharedPreferences>()));
  gh.lazySingleton<_i32.LocalizationRepository>(() =>
      _i33.LocalizationRepositoryImpl(get<_i30.LocalizationLocalDataSource>()));
  gh.factory<_i34.OrdersCubit>(
      () => _i34.OrdersCubit(get<_i29.GetOrderDetailsUseCase>()));
  gh.lazySingleton<_i35.ProductsRepository>(() => _i36.ProductsRepositoryImpl(
      get<_i10.ProductsRemoteDataSource>(),
      get<_i19.AuthLocalDataSource>(),
      get<_i30.LocalizationLocalDataSource>()));
  gh.lazySingleton<_i37.ProfileRepository>(() => _i38.ProfileRepositoryImpl(
      get<_i39.ProfileRemoteDataSource>(), get<_i19.AuthLocalDataSource>()));
  gh.lazySingleton<_i40.RestaurantsRepository>(() =>
      _i41.RestaurantsRepositoryImpl(
          get<_i15.RestaurantsRemoteDataSource>(),
          get<_i19.AuthLocalDataSource>(),
          get<_i30.LocalizationLocalDataSource>()));
  gh.lazySingleton<_i42.ViewProfileUseCase>(
      () => _i42.ViewProfileUseCase(get<_i37.ProfileRepository>()));
  ...
  gh.lazySingleton<_i45.CartRepository>(() => _i46.CartRepositoryImpl(
      get<_i19.AuthLocalDataSource>(),
      get<_i24.CartRemoteDataSource>(),
      get<_i30.LocalizationLocalDataSource>()));
  gh.lazySingleton<_i47.ChangeLanguageUseCase>(
      () => _i47.ChangeLanguageUseCase(get<_i32.LocalizationRepository>()));
  gh.lazySingleton<_i48.CheckoutRepository>(() => _i49.CheckoutRepositoryImpl(
      get<_i27.CheckoutRemoteDataSource>(),
      get<_i19.AuthLocalDataSource>(),
      get<_i30.LocalizationLocalDataSource>()));
  ...
  gh.lazySingleton<_i52.EditProfileUseCase>(
      () => _i52.EditProfileUseCase(get<_i37.ProfileRepository>()));
  ...
  gh.lazySingleton<_i55.GetLanguageUseCase>(
      () => _i55.GetLanguageUseCase(get<_i32.LocalizationRepository>()));
  gh.lazySingleton<_i56.GetProductDetailsUseCase>(
      () => _i56.GetProductDetailsUseCase(get<_i35.ProductsRepository>()));
